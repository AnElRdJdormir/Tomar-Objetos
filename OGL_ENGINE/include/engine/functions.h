...
void collidedObject_callback(string nameCollidedObject)
{
    const char* text = "";
    //NUEVO
    if (nameCollidedObject == "Cohete")
    {
        colisionCohete = true;
        text = "Cohete encontrado";
        showSecondMessage = true;
        Text->RenderText(text, -0.55f, 0.7f, 0.002f, glm::vec3(0.0f, 0.0f, 0.0f)); //despues de glm::vec3 es el color:)
        secondMessage->Draw(glm::vec2(0.0f, -0.75f), 1.0f);
    }
    else
        colisionCohete = false;

    if (nameCollidedObject == "Coin")
    {
        colisionCoin = true;
        text = "Coin encontrado";
        showSecondMessage = true;
        Text->RenderText(text, -0.55f, 0.7f, 0.002f, glm::vec3(0.0f, 0.0f, 0.0f)); //despues de glm::vec3 es el color:)
        secondMessage->Draw(glm::vec2(0.0f, -0.75f), 1.0f);
    }
    ...
    if (nameCollidedObject == "JoyStick")
    {
        colisionJoyStick = true;
        text = "JoyStick encontrado";
        showSecondMessage = true;
        Text->RenderText(text, -0.55f, 0.7f, 0.002f, glm::vec3(0.0f, 0.0f, 0.0f)); //despues de glm::vec3 es el color:)
        secondMessage->Draw(glm::vec2(0.0f, -0.75f), 1.0f);
    }
    else
        colisionJoyStick = false;
