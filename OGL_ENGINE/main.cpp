...
int main()
{
    ...
    //:::: CREAMOS LA VENTANA:::://
    GLFWwindow *window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Tomar Objetos", NULL, NULL);
    if (window == NULL)
    {
...
void initScene(Shader ourShader)
{
    ...
    pickModels.push_back(Model("Cohete", "models/Cohete.obj", glm::vec3(5.3, 0.5, -4.3), glm::vec3(0, 0, 0), 0.0f, initScale));
    pickModels.push_back(Model("Cohete2", "models/Cohete.obj", glm::vec3(0.7f, -1.0f, -0.4f), glm::vec3(0, -95, 23), 0.0f, 0.8));
    
    pickModels.push_back(Model("Coin", "models/Coin.obj", glm::vec3(6.3, 0.5, -2.3), glm::vec3(0, 0, 0), 0.0f, initScale));
    pickModels.push_back(Model("Coin2", "models/Coin.obj", glm::vec3(0.7f, -1.0f, -0.4f), glm::vec3(0, -95, 23), 0.0f, 0.8));
   
    pickModels.push_back(Model("JoyStick", "models/JoyStick.obj", glm::vec3(8.3, 0.5, -8.3), glm::vec3(0, 0, 0), 0.0f, initScale));
    pickModels.push_back(Model("JoyStick2", "models/JoyStick.obj", glm::vec3(0.7f, -1.0f, -0.4f), glm::vec3(0, -95, 23), 0.0f, 0.8));
...
void pickObjects(Shader* ourShader, Shader* selectShader, glm::mat4 projection)
{
    ...
    if (pickObject && colisionJoyStick)
    {
        selectShader->use();
        setSimpleLight(selectShader);
        pickModels[5]
